...
public class Pending_Class extends AppCompatActivity implements  Pending_Adapter_one.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView =findViewById(R.id.pending_recycle);
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    PopupMenu popup = new PopupMenu(Pending_Class.this, v);
                            ...
                            switch (id) {
                                ...
                                case R.id.date:
                                    ...
                                    if (date != null){
                                        ...
                                        Toast.makeText(Pending_Class.this, "Date is required.", Toast.LENGTH_SHORT).show();
                                    }
...
//        });
        ...
        calende.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Pending_Class.this, dateA, calendar.get(Calendar.YEAR),
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (image != "null"){
                    Glide.with(Pending_Class.this).load(image).into(porfile_img);
                }
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try {
                                            ...
                                            if (success.equals("true")){
                                                ...
                                                dialog2.dismiss();
                                                String token = null;
                                                PreferenceUtils.saveTokan(token,Pending_Class.this);
                                                Intent i = new Intent(Pending_Class.this, SplashScreen.class);
                                                startActivity(i);
                                            }
...
//
//
//        adapter_one =  new Pending_Adapter_one(Pending_Class.this,pendingModelOneList);
//        plan.setAdapter(adapter_one);
//        plan.setLayoutManager(new LinearLayoutManager(Pending_Class.this, LinearLayoutManager.HORIZONTAL, false));
...
//
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                Map<String,String> params = new HashMap<String, String>();
                params.put("Accept", "application/json");
                params.put("Authorization", "Bearer  " + PreferenceUtils.getTokan(Pending_Class.this));
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Pending_Class.this);
        requestQueue.getCache().clear();
        requestQueue.add(jsonObjectRequest);
...
//                    Toast.makeText(AdminActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
                ...
                plan.setAdapter(adapter_one);
                plan.setLayoutManager(new LinearLayoutManager(Pending_Class.this, LinearLayoutManager.HORIZONTAL, false));
                adapter_one.setOnItemClickListener(Pending_Class.this);
...
//                    Toast.makeText(Pending_Class.this, response.toString(), Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    LinearLayoutManager layoutManager1=new LinearLayoutManager(Pending_Class.this){
                        @Override
                    ...
                    adapter =  new Pending_Adapter(Pending_Class.this,pending_modelList);
